    ...
    <Card sx={{ position: 'relative', overflow: 'hidden' }} className={'border-none! shadow-none! printable-area'}>
      ...
      <CardContent className='sm:p-12!'>
        ...
        <Grid container spacing={0} direction={'column'} gap={0}>
          ...
          >
            {documenttype === DocumentTypes.PROFORMA || documenttype === DocumentTypes.FACTURE ? (
              ...
              >
                <Typography className={'font-bold text-start text-xl uppercase'}>
                  FACTURE {documenttype === DocumentTypes.PROFORMA ? DocumentTypes.PROFORMA : ''}
                </Typography>
              </Grid>
            ) : null}
          </Grid>
          <Grid size={12}>
            ...
            <table className='w-full border border-collapse  text-sm'>
              ...
              <tbody>
                {docs.articleQuantites.map((item, index) => (
        ...
        >
          ...
          >
            <Typography className={'border-t-2 border-gray-950 text-primary'}>
              AGOE LEGBASSITO, QTE AHONKPOE, 50M DU MARCHE BELGIQUE, 6.277888 – 1.168199
            </Typography>
            <Typography className={'text-primary'}>
              <span className={'text-[#92d050]'}>T:</span> (+228) 93 94 44 44,{' '}
              <span className={'text-[#92d050] '}>E:</span> CONTACT@SOOSMART.GROUP,{' '}
              <span className={'text-[#92d050]'}>W:</span> WWW.SOOSMART.GROUP
            </Typography>
            <Typography className={'text-primary'}>
              <span className={'text-[#92d050]'}>RC:</span> TG-LOM 2020 B 0394,{' '}
              <span className={'text-[#92d050]'}>NIF:</span> 1001652884
            </Typography>
          </Grid>
        </Grid>
      </CardContent>
