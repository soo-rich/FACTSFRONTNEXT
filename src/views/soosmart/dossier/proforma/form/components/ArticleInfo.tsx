...
import { Grid as Grid2, Button } from '@mui/material'
...
const ArticleInfo = ({ initaldata, onAppend, onUpdate, onCancel }: ArticleInfoProps) => {
  ...
  const submitForm = (data: Article_QuantiteListV2) => {
    initaldata ? onUpdate(data) : onAppend(data)
    handleCancel()
  }
        ...
        <Grid2 container direction={'column'} spacing={3} size={7.5}>
          ...
          <Grid2>
            <div className='flex justify-center gap-4 mt-6'>
              ...
              <Button variant='contained' color='primary' type='button' onClick={handleSubmit(submitForm)}>
