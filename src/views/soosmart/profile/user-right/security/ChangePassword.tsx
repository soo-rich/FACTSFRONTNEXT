...
const ChangePassword = () => {
  ...
  const handleMutation = useMutation({
    ...
    onSuccess: (data) => {
      data ? toast.success('Mot de passe changé avec succès') : toast.error('Erreur lors du changement de mot de passe')
      setIsOk(data)
        ...
        <form onSubmit={handleSubmit(submitForm)} noValidate>
          <Grid container spacing={4}>
                      ...
                      input: {
                        endAdornment: (
                          <InputAdornment position="end">
                            <IconButton edge="end" onClick={() => setIsOldPasswordShown(!isOldPasswordShown)}>
            ...
            <Grid size={{ xs: 12 }} className="flex gap-4">
              <Button type="submit" disabled={handleMutation.isPending} variant="contained">
