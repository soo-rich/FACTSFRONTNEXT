...
export const userCreateSchema = z.object({
  ...
  numero: z
    ...
    .regex(/^[0-9]*$/, { message: 'Le numéro doit contenir uniquement des chiffres' }),
  username: z
    .string()
    .min(4, { message: "Le nom d'utilisateur doit contenir au moins 4 caractères" })
    .max(9, { message: "Le nom d'utilisateur doit contenir au maximum 9 caractères" }),
...
export const changePasswordSchema = z
  .object({
    password: z.string().min(1, { message: 'Le mot de passe actuel est requis' }),
    newpassword: z.string().min(1, { message: 'Le nouveau mot de passe est requis' }),
